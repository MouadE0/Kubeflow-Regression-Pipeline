...
def hist_gradient_boosting_regression(split_data: dict, score: float) -> float:
    ...
    regr = HistGradientBoostingRegressor(max_depth=2, random_state=0)
    ...
    print(f"The Score of Hist Gradient Boosting Regression is {score}")
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Hist Gradient Boosting Regression')
    ...
    hist_gradient_boosting_regression(split_data=args.split_data, score=args.score)
