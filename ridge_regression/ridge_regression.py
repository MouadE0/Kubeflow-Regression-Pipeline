...
def ridge_regression(split_data: dict, score: float) -> float:
    ...
    print(f"The Score of Ridge Regression is {score}")
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Ridge Regression Modeling')
    ...
    ridge_regression(split_data=args.split_data, score=args.score)
