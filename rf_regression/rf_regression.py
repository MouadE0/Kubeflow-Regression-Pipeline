...
def rf_regression(split_data: dict, score: float) -> float:
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Random Forest Regression Modeling')
    ...
    rf_regression(split_data=args.split_data, score=args.score)
